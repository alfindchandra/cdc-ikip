                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="jenis" name="jenis" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 px-4 py-2" required>
                           ...
                           <option value="webinar" {{ old('jenis') == 'webinar' ? 'selected' : '' }}>Webinar</option>
                            <option value="seminar" {{ old('jenis') == 'seminar' ? 'selected' : '' }}>Seminar</option>
                            <option value="bimbingan_karier" {{ old('jenis') == 'bimbingan_karier' ? 'selected' : '' }}>Bimbingan Karier</option>
            ...
            <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="text-sm text-indigo-800">
                        ...
                        <p>Pelatihan yang baru dibuat akan disimpan sebagai **Draft** secara otomatis. Pelatihan **tidak akan terlihat** oleh mahasiswa sebelum Anda mengubah statusnya menjadi **Published** di halaman detail.</p>
                    </div>
                </div>
            </div>
