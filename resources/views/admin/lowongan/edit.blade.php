    ...
    <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
        ...
        >
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            <strong>Perhatian:</strong> Pastikan semua informasi yang dimasukkan sudah benar. Perubahan akan langsung terlihat oleh mahasiswa/mahasiswa yang mengakses lowongan ini.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.lowongan.show', $lowongan->id) }}" class="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 text-sm font-medium transition">
                    Batal
                </a>
