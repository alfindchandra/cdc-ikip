...
<body class="bg-gray-50">
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mb-4">
                        Membantu mahasiswa dan alumni meraih karir impian melalui layanan penempatan kerja dan pelatihan
                        profesional.
                    </p>
                    <div class="flex space-x-3">
                        <a href="#"
                            class="w-8 h-8 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-purple-600 transition">
    ...
    <button id="scrollToTop"
        class="fixed bottom-8 right-8 w-12 h-12 gradient-primary rounded-full shadow-lg items-center justify-center hidden hover:opacity-90 transition z-50">
        ...
        button.addEventListener('click', function() {
            ...
            document.querySArray('.faq-content').forEach(otherContent => {
                if (otherContent !== content && !otherContent.classList.contains('hidden')) {
                    ...
                    otherContent.previousElementSibling.querySelector('i').classList.remove(
                        'rotate-180');
                }
            });
        });
