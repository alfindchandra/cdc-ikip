      ...
      <div class="flex justify-between items-center transition-all duration-300">
        ...
        <div class="flex items-center gap-8">
          ...
          <div class="hidden lg:flex items-center space-x-1 xl:space-x-2">
            <a href="{{ route('index.lowongan') }}" :class="isScrolled ? 'text-gray-800 hover:text-blue-600' : 'text-white hover:text-white/80'" class="px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200">Lowongan</a>
            <a href="{{ route('index.perusahaan') }}" :class="isScrolled ? 'text-gray-800 hover:text-blue-600' : 'text-white hover:text-white/80'" class="px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200">Perusahaan</a>
            <a href="{{ route('pelatihan.index') }}" :class="isScrolled ? 'text-gray-800 hover:text-blue-600' : 'text-white hover:text-white/80'" class="px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200">Pelatihan</a>
            <a href="{{ route('index.tracer-study') }}" :class="isScrolled ? 'text-gray-800 hover:text-blue-600' : 'text-white hover:text-white/80'" class="px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200">Tracer Study</a>
            <a href="{{ route('index.faq') }}" :class="isScrolled ? 'text-gray-800 hover:text-blue-600' : 'text-white hover:text-white/80'" class="px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200">FAQ</a>
          </div>
        </div>
              ...
              <div class="relative" @click.away="dropdownDesktop = false">
                ...
                >
                  <div class="p-2 flex flex-col space-y-0.5">
                    ...
                    <a href="{{ route('mahasiswa.eportfolio.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-100 rounded-lg transition">
                      <svg class="w-5 h-5 fill-current text-slate-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <div x-show="open" 
      ...
      <div>
        ...
        <nav class="flex flex-col space-y-1">
          <a href="{{ route('welcome') }}" @click="open = false" class="flex items-center text-gray-300 hover:text-white hover:bg-white/5 px-3 py-2.5 rounded-xl font-medium transition">Beranda</a>
          <a href="{{ route('index.lowongan') }}" @click="open = false" class="flex items-center text-gray-300 hover:text-white hover:bg-white/5 px-3 py-2.5 rounded-xl font-medium transition">Lowongan</a>
          <a href="{{ route('pelatihan.index') }}" @click="open = false" class="flex items-center text-gray-300 hover:text-white hover:bg-white/5 px-3 py-2.5 rounded-xl font-medium transition">Pelatihan</a>
          <a href="{{ route('index.tracer-study') }}" @click="open = false" class="flex items-center text-gray-300 hover:text-white hover:bg-white/5 px-3 py-2.5 rounded-xl font-medium transition">Tracer Study</a>
          <a href="{{ route('index.perusahaan') }}" @click="open = false" class="flex items-center text-gray-300 hover:text-white hover:bg-white/5 px-3 py-2.5 rounded-xl font-medium transition">Perusahaan</a>
