    ...
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex items-center space-x-8">
        ...
        <div class="hidden lg:flex items-center space-x-4">
          ...
          <div class="relative" x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
            <button class="flex items-center text-gray-600 hover:text-blue-600 px-3 py-2 text-sm font-medium transition">
              Bantuan
              <svg class="ml-1 h-4 w-4 transform transition duration-200" :class="open ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div 
              ...
              class="absolute mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden z-50"
            >
              <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-600 hover:text-white">Informasi</a>
              <a href="https://karir.itb.ac.id/faq" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-600 hover:text-white">F.A.Q</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center space-x-3">
        ...
        <div class="hidden lg:flex items-center space-x-3">
          <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 font-semibold px-3 py-2 rounded-lg transition">Masuk</button>
          <a href="https://karir.itb.ac.id/registration" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow">Register</a>
          <a href="https://karir.itb.ac.id/post-a-job" class="border border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold py-2 px-4 rounded-lg transition">Posting Pekerjaan</a>
        </div>
